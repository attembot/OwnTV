...
class OwnTVApp : Application(), SingletonImageLoader.Factory, androidx.work.Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        // Fork: check THIS fork's releases. Upstream's APKs could never install over this build anyway
        // (different signing key and application id), and the fork's dated versions outrank every 4.x/5.x.
        tv.own.owntv.core.CoreBuildInfo.releaseRepo = "attembot/OwnTV"
